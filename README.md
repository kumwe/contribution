...
The recorded 0.1.0 is a proposed release record, not a publication claim. Exact pins are required before 1.0. The
...
[Integration](docs/integration.md) documents the intentional migration from SDK kind branching.
...
This is Phase 1. Human merge, automatic release and independent attestation precede a separate SDK successor release,
then App adoption. No legacy aliases, remaps or production fallback are supplied.
